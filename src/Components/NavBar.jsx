        ...
        <nav className="navbar bg-light shadow-sm">
            <div className="container-fluid">
                ...
                <form className="d-flex me-5" role="search">
                    ...
                    { user ? <a className="nav-link text-dark fs-5" href="#"><i className="fa-regular fa-heart" /></a> : '' }
                    <div className="dropdown ms-5">
                        { user ? <> <button className="btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown">
